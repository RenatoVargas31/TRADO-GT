    ...
    public void sendMessage(String email, String messageEmail) {
        try {
            ...
            String htmlContent = "<!DOCTYPE html>" +
                    ...
                    "                            <a href='https://app.tradogt.shop' style='display: inline-block; margin-top: 20px; padding: 12px 24px; background-color: #800080; color: #ffffff; text-decoration: none; border-radius: 5px; font-size: 16px;'>Iniciar Sesión</a>" +
                    "                        </td>" +
                    "                    </tr>" +
                    "                </table>" +
                    "            </td>" +
